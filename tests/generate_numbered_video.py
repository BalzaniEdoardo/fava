...
if __name__ == "__main__":
    save_dir = pathlib.Path(__file__).parent / "test_video"
    save_dir.mkdir(exist_ok=True)
    generate_numbered_video(save_dir / "numbered_video.mp4")
    generate_numbered_video(save_dir /"numbered_video.avi")
    generate_numbered_video(save_dir /"numbered_video.mkv")
